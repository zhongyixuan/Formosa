...
public class MyCarpoolOwnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_carpool_owner);

        textViewTravelName = (TextView) findViewById(R.id.textViewTravelName);
        travelDateList = (ListView) findViewById(R.id.listView);
        Button buttonCancelPair = (Button) findViewById(R.id.buttonCancelPair);
        ...
        buttonCancelPair.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void run() {
                        try {
                            ...
                            if (tmp.equals("0")) {
                                ...
                                Toast toast = Toast.makeText(MyCarpoolOwnerActivity.this, "失敗請重試", Toast.LENGTH_SHORT);
                                toast.show();
                            }
            ...
            public ArrayList<HashMap<String, Object>> call() throws Exception {
                ...
                try {
                    ...
                    if (tmp.equals("0")) {
                        ...
                        Toast toast = Toast.makeText(MyCarpoolOwnerActivity.this, "發生失敗請重試", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                    System.out.println(result);
    ...
    private void deleteTravelPair(){
        final String url = "http://140.131.114.161:8080/Formosa/rest/travelPair/deleteTravelPair";
    }
}
