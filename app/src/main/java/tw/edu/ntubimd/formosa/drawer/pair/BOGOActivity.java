...
public class BOGOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final PairViewPagerAdapter adapter = new PairViewPagerAdapter(getSupportFragmentManager(), mTabs.getTabCount());
