...
import tw.edu.ntubimd.formosa.drawer.travel.TravelDetailActivity;

public class AllCarpoolDetailActivity extends AppCompatActivity {

    private TextView textViewTravelName;
    private ListView travelDateList;
    private String travelID, userID, travePairID;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_carpool_detail);
        ...
        buttonPair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(AllCarpoolDetailActivity.this, AddCarpoolActivity.class);
                intent.putExtra("userID", userID); //將參數放入
                    ...
                    public void run() {
                        try {
                            ...
                            if (tmp.equals("0")) {
                                ...
                                userID = travelJSON.get("userID").toString();
                            } else {
                                Toast toast = Toast.makeText(AllCarpoolDetailActivity.this, "失敗請重試", Toast.LENGTH_SHORT);
                                toast.show();
                            }
            ...
            public ArrayList<HashMap<String, Object>> call() throws Exception {
                ...
                try {
                    ...
                    if (tmp.equals("0")) {
                        ...
                        Toast toast = Toast.makeText(AllCarpoolDetailActivity.this, "發生失敗請重試", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                    System.out.println(result);
