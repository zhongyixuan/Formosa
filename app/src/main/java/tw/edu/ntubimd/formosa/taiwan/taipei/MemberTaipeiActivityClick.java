...
import tw.edu.ntubimd.formosa.MemberViewPagerAdapter;
import tw.edu.ntubimd.formosa.R;
import tw.edu.ntubimd.formosa.ViewPagerAdapter;

public class MemberTaipeiActivityClick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_taipei_click);
        ...
        final MemberViewPagerAdapter adapter = new MemberViewPagerAdapter(getSupportFragmentManager(), mTabs.getTabCount());
